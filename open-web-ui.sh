...
docker run -d -p 3000:8080 --add-host=host.docker.internal:host-gateway \
  ...
  -e MODELS_CACHE_TTL=300 \
  -e DEFAULT_MODELS="~google/gemini-pro-latest" \
  -e DEFAULT_PINNED_MODELS="openai/gpt-5.5-pro,~google/gemini-pro-latest,~anthropic/claude-opus-latest" \
